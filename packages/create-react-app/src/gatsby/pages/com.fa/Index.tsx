...
import {BusinessSite, CircleComponent} from "../../../business";
        ...
        {/* TODO HERO-1 */}
                    ...
                    <Row>
                        <Col>
                            <div className="d-inline-block">
                                <h1 className="font-weight-bold mb-3" style={{fontSize: "2.5rem"}}>Technology used by millions</h1>
                            </div>
                        </Col>
                    </Row>
            ...
            >
                <Col className={"text-center"} css={{paddingTop: "6rem"}}>
                    <Row>
                        <Col>
                            <div className="d-inline-block">
                                <h1 className="font-weight-bold mb-3" style={{fontSize: "2.5rem"}}>Explore. Find. Own.</h1>
                            </div>
                        </Col>
                    </Row>
                    <Row>
            ...
            {/* TODO CONTENT-1 */}
            {
                [
                    ...
                    <Row key={`${f.title}-${index}`} className={`justify-content-center position-relative ${f.inverse ? "flex-md-row-reverse" : ""}`} css={f.css}>
                            ...
                            <Row css={{background:"initial"}}>
                                <Col>
                                    <Row>
                                        <Col>
                                            <div className="d-inline-block">
                                                <h1 className="font-weight-bold mb-3" style={{fontSize: "2.5rem"}}>{f.subTitle}</h1>
                                            </div>
                                        </Col>
                                    </Row>
                                    <Row>
                                        ...
                                        <Card.Body css={{padding:".75rem"}}>
                                            <blockquote className="blockquote mb-0">
                                                ...
                                                <footer className="blockquote-footer" css={{"&:before":{content:`""`}}}>
                                                    ...
                                                    <div className="d-inline-block">
                                                        <strong className="text-dark" style={{fontSize:13}}>| {f.author}</strong>
                                                    </div>
                                                </footer>
                                            </blockquote>
                                        </Card.Body>
